export const equipmentCategoryDefinitions = [
  ...
  {
    key: 'mediaPower',
    label: 'Μέσα και Τροφοδοσία',
    description: 'Μπαταρίες, κάρτες μνήμης, φορτιστές και απαραίτητη τροφοδοσία γυρίσματος.',
    accent: '#3b5e67',
    surface: '#e9f2f4',
  },
  {
    key: 'gripSupport',
    label: 'Στήριξη και Grip',
